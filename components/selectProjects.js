            ...
            <div className="projectList inset-0 flex flex-col flex-nowrap items-center top-[18%] md:top-[25%] lg:top-[40%] absolute h-auto">
                <div className="relative">
                    ...
                    <div className=" hexagonGallery mt-2 md:mt-24 flex flex-row flex-wrap  justify-center gap-4">
                       ...
                       <Link href={'/projects'}>
                           <div className="cursor-pointer projectButton flex justify-center m-auto max-w-[50vw] md:max-w-[30vw] w-auto text-secondary-100 text-xl md:text-2xl p-2 mt-8 md:mt-12 lg:mt-24 rounded-2xl duration-200 border-2 border-secondary-100 hover:scale-110 duration-200">
